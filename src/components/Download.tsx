    ...
    <section id="download" className="px-6 py-24">
      ...
      >
        ...
        <p className="text-foreground-secondary text-lg max-w-xl mx-auto mb-8">
          Download Steward and never miss a reward again. Free to use, works
          offline, and supports 100+ credit cards from every major issuer.
        </p>

        {/* App Store button placeholder */}
        <a
          href="#"
          className="inline-flex items-center gap-3 bg-foreground text-background font-medium px-8 py-4 rounded-2xl hover:opacity-90 transition-opacity"
        >
          <svg
            viewBox="0 0 24 24"
            fill="currentColor"
